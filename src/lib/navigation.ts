  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { kind: "link", to: "/menu/engineering", label: "Menu engineering", description: "Stars, plowhorses & classifications", icon: IconChart, requires: ["MENU_VIEW", "REPORTS_VIEW"] },
        { kind: "link", to: "/menu/price-advisor", label: "Price advisor", description: "Suggested prices based on margins & P&L", icon: IconChart, requires: ["MENU_VIEW", "REPORTS_VIEW"] },
